...
<head>
    ...
    <title>中国电影ZGDY.CN - 免费在线视频搜索与观看平台</title>
    <meta name="description" content="中国电影ZGDY.CN是一个免费的在线视频搜索平台，无广告、安全，提供来自多个视频源的内容搜索与观看服务，无需注册即可使用。">
    <meta name="keywords" content="在线视频,免费视频,视频搜索,电影,电视剧,LibreTV">
    <meta name="author" content="中国电影ZGDY.CN">
            ...
            <header class="text-center mb-2">
                <div class="flex justify-center items-center mb-4">
                    <a href="#" onclick="resetToHome(); return false;" class="flex items-center">
                        ...
                        <h1 class="text-5xl font-bold gradient-text">中国电影ZGDY.CN</h1>
                    </a>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-4 md:mb-0">
                    <div class="flex items-center justify-center md:justify-start">
                        ...
                        <span class="gradient-text font-bold">中国电影ZGDY.CN</span>
                    </div>
                    <p class="text-gray-500 text-sm mt-2 text-center md:text-left">© 2025 中国电影ZGDY.CN - 自由观影，畅享精彩</p>
                </div>
    ...
    <div id="disclaimerModal" class="fixed inset-0 bg-black/90 hidden items-center justify-center z-[60]">
        <div class="bg-[#111] p-8 rounded-lg border border-[#333] w-11/12 max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="text-gray-300 space-y-4">
                <p>
                    欢迎使用 中国电影ZGDY.CN。在开始使用前，请您了解并同意以下条款：
                </p>
                <p>
                    <strong class="text-blue-400">服务性质：</strong> 中国电影ZGDY.CN 仅提供视频搜索服务，不直接提供、存储或上传任何视频内容。所有搜索结果均来自第三方公开接口。
                </p>
                <p>
